...
_this setObjectTexture [4, "\Jonzie_Carpack\Universal_Cars\Number_Plates\-.paa"];
_this setObjectTexture [1, format ["\Jonzie_Carpack\Universal_Cars\Number_Plates\%1.paa",_plate1]];
_this setObjectTexture [2, format ["\Jonzie_Carpack\Universal_Cars\Number_Plates\%1.paa",_plate2]];
_this setObjectTexture [3, format ["\Jonzie_Carpack\Universal_Cars\Number_Plates\%1.paa",_plate3]];
_this setObjectTexture [5, format ["\Jonzie_Carpack\Universal_Cars\Number_Plates\%1.paa",_plate5]];
_this setObjectTexture [6, format ["\Jonzie_Carpack\Universal_Cars\Number_Plates\%1.paa",_plate6]];
_this setObjectTexture [7, format ["\Jonzie_Carpack\Universal_Cars\Number_Plates\%1.paa",_plate7]];
