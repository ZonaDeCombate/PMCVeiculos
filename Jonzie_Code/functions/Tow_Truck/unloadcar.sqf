...
{
	_height = _height + 1.3;_distance = _distance - 0;_Edistance = _distance - 5.5;_Eheight = _height - 1;
	_UnSupported_Vehicle_Height = getNumber (configFile >> "CfgVehicles" >> Typeof _towing >> "Unload_Height");_height = _UnSupported_Vehicle_Height;
	_UnSupported_Vehicle_Distance = getNumber (configFile >> "CfgVehicles" >> Typeof _towing >> "Unload_Distance"); _distance = _UnSupported_Vehicle_Distance;
	_UnSupported_Vehicle_End_Height = getNumber (configFile >> "CfgVehicles" >> Typeof _towing >> "Unload_End_Height");_Eheight = _UnSupported_Vehicle_End_Height;
	_UnSupported_Vehicle_End_Distance = getNumber (configFile >> "CfgVehicles" >> Typeof _towing >> "Unload_End_Distance");_Edistance = _UnSupported_Vehicle_End_Distance;
};
